...
class AnalyzeTest {
    ...
    @Test
    void whenTwoRemovedAndOneChanged() {
        User u1 = new User(1, "A");
        User u2 = new User(2, "B");
        User u3 = new User(3, "C");
        Set previous = Set.of(u1, u2, u3);
        Set current = Set.of(new User(3, "CC"));
        assertThat(Analyze.diff(previous, current)).isEqualTo(new Info(0, 1, 2));
    }

    @Test
    void whenOneRemovedAndTwoChanged() {
         User u1 = new User(1, "A");
         User u2 = new User(2, "B");
         User u3 = new User(3, "C");
         Set previous = Set.of(u1, u2, u3);
         Set current = Set.of(new User(1, "AA"), new User(3, "CC"));
         assertThat(Analyze.diff(previous, current)).isEqualTo(new Info(0, 2, 1));
     }
}