...
class SimpleMapTest {
    ...
    @Test
    void whenGetKeyNotEqualsValue() {
        SimpleMap<Integer, String> map = new SimpleMap<>();
        map.put(6, "6");
        assertThat(map.get(4)).isNotEqualTo("3");
        assertThat(map.get(6)).isNotEqualTo("six");
    }
